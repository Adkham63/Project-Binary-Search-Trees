// NodeFactory: Creates a new node with left and right pointers
...
// TreeFactory: Creates a BST from an array and provides various operations
const TreeFactory = (arr) => {
  ...
  // Sorts input array & removes duplicates
  ...
  // Inserts node of a specific value into BST
  ...
  // Deletes a node of a specific value from BST
  ...
  // Helper function for deleteNode - returns the smallest value in the right branch
  ...
  // Finds & returns a node of a specified value
  ...
  // passes each node into the specified callback f(x) 
  // (otherwise returns an array of visited nodes)
  ...
  // Traverses BST in depth-first inorder traversal & 
  // passes each node into the specified callback f(x) 
  // (otherwise returns an array of visited nodes)
